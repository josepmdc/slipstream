...
type Config struct {
	...
	SegmentCacheMaxSize     int           `env:"SEGMENT_CACHE_MAX_SIZE"    envDefault:"10000"`
	SegmentCacheExpiration  time.Duration `env:"SEGMENT_CACHE_EXPIRATION"  envDefault:"60s"`
	ManifestCacheMaxSize    int           `env:"MANIFEST_CACHE_MAX_SIZE"   envDefault:"100"`
	ManifestCacheExpiration time.Duration `env:"MANIFEST_CACHE_EXPIRATION" envDefault:"4s"`
}
